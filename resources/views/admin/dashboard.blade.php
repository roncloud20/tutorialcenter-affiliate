<x-dashboard-layout title="Admin Dashboard">
    ...
    <div class="grid gap-6 md:grid-cols-3">
        ...
        <a href="{{ route('admin.earnings.pending') }}"
            class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <p class="text-sm text-gray-500 dark:text-slate-400">Pending Earnings</p>
    ...
    <div class="mt-8 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div class="mb-5 flex items-center justify-between">
            ...
            <a href="{{ route('admin.earnings.pending') }}" class="text-sm font-semibold text-[#ed1c24]">
                View All
            </a>
        </div>
            ...
            <div class="rounded-xl bg-gray-50 p-4 dark:bg-slate-950">
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="text-left sm:text-right">
                        <p class="text-xl font-extrabold text-[#ed1c24]">
